 ...
 * a perfectly valid estimated plan for MySQL, SQL Server, Oracle, Dameng, Doris
 ...
 */
const PARSERS = new Map([[postgresParser.database, postgresParser]]);
