 ...
 * @property {"postgresql"} database Database family the raw plan came from.
 ...
 *   properties are expected at all.
 * @property {"json"} format Serialization of `plan`. Text plans are a separate
 *   contract value to be added when a parser for them exists.
...
export const SUPPORTED_DATABASES = ["postgresql"];
export const SUPPORTED_MODES = ["estimated", "actual"];
export const SUPPORTED_FORMATS = ["json"];
