#!/usr/bin/env node
/**
 * Regenerate the golden files under fixtures/postgres/golden/ from the current
 * offline pipeline.
 *
...
import { goldenPathFor, listFixtures, loadFixture, relativeToRepo } from "../tests/helpers/fixtures.js";
